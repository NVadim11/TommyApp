				...
				{idleState ? (
					<div className='mainContent__phaseOne'>
						<div className='mainContent__infoBlock'>
							...
							<div className='mainContent__walletBtnBox'>
								<WalletMultiButton
									style={{
								...
								<button
									className='mainContent__startBtn'
									onClick={startFarm}
						...
						<div className='mainContent__guideItems'>
							...
							>
								<div className='mainContent__refFriends'>
									...
									>
										<path
											d='M29.9966 6.75658C29.7623 10.0083 27.349 12.5132 24.7174 12.5132C22.0858 12.5132 19.6686 10.0091 19.4382 6.75658C19.1983 3.37379 21.5475 1 24.7174 1C27.8874 1 30.2366 3.43535 29.9966 6.75658Z'
											stroke='white'
											strokeWidth='2'
											strokeLinecap='round'
										...
										/>
										<path
											d='M24.717 17.1182C19.6105 17.1182 14.7 19.6471 13.4698 24.5721C13.3068 25.2236 13.7166 25.8682 14.3881 25.8682H35.0466C35.7181 25.8682 36.1255 25.2236 35.9649 24.5721C34.7347 19.5682 29.8242 17.1182 24.717 17.1182Z'
											stroke='white'
											strokeWidth='2'
											strokeMiterlimit='10'
										/>
										<path
											d='M14.3425 8.13317C14.1601 10.5832 12.2594 12.5127 10.2107 12.5127C8.1619 12.5127 6.25815 10.5839 6.07884 8.13317C5.89252 5.58436 7.74248 3.7627 10.2107 3.7627C12.6788 3.7627 14.5288 5.63112 14.3425 8.13317Z'
											stroke='white'
											strokeWidth='2'
											strokeLinecap='round'
											strokeLinejoin='round'
										/>
										<path
											d='M14.8158 17.5424C13.3827 16.9038 11.8043 16.6582 10.1314 16.6582C6.00277 16.6582 2.02499 18.6545 1.02857 22.5429C0.897561 23.0572 1.22944 23.5661 1.77251 23.5661H10.6872'
											stroke='white'
											strokeWidth='2'
											strokeMiterlimit='10'
											strokeLinecap='round'
							...
							>
								<div className='mainContent__earnPoins'>
									...
									>
										<path
											d='M36.5703 17.7393V24.0163C36.5703 26.7364 30.0128 30.2934 21.9238 30.2934C13.8348 30.2934 7.27734 26.7364 7.27734 24.0163V18.7854'
											stroke='white'
											strokeWidth='2'
											strokeLinecap='round'
											strokeLinejoin='round'
										/>
										<path
											d='M7.89209 19.3271C9.70198 21.7292 15.299 23.9826 21.9234 23.9826C30.0124 23.9826 36.5699 20.6223 36.5699 17.7349C36.5699 16.1133 34.5047 14.3369 31.2637 13.0898'
											stroke='white'
											strokeWidth='2'
											strokeLinecap='round'
											strokeLinejoin='round'
										/>
										<path
											d='M30.2929 7.27734V13.5544C30.2929 16.2745 23.7355 19.8315 15.6465 19.8315C7.55743 19.8315 1 16.2745 1 13.5544V7.27734'
											stroke='white'
											strokeWidth='2'
											strokeLinecap='round'
											strokeLinejoin='round'
										...
										<path
											fillRule='evenodd'
											clipRule='evenodd'
											d='M15.6465 13.5206C23.7355 13.5206 30.2929 10.1603 30.2929 7.27287C30.2929 4.38333 23.7355 1 15.6465 1C7.55743 1 1 4.38333 1 7.27287C1 10.1603 7.55743 13.5206 15.6465 13.5206Z'
											stroke='white'
											strokeWidth='2'
											strokeLinecap='round'
											strokeLinejoin='round'
