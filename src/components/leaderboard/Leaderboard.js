...
<div id="leaderboard" aria-hidden="true" className="popupLeaderboard">
	<div className="popupLeaderboard__wrapper">
		<div className="popupLeaderboard__content">
			<button data-leaderboard-close type="button" className="popupLeaderboard__close">
				{/* <svg width="24" height="24"
					viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M12 12L2 2M12 12L22 22M12 12L22 2M12 12L2 22" stroke="white" stroke-width="3" stroke-linecap="round"
